...
impl GcpProvider {
    pub(super) fn functions_function_schema() -> smelt_provider::ResourceTypeInfo {
                    ...
                    smelt_provider::SectionSchema {
                        ...
                        fields: vec![
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["ENVIRONMENT_UNSPECIFIED".into(), "GEN_1".into(), "GEN_2".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
