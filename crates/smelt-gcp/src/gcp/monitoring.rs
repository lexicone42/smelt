...
impl GcpProvider {
    pub(super) fn monitoring_alertpolicy_schema() -> smelt_provider::ResourceTypeInfo {
                    ...
                    smelt_provider::SectionSchema {
                        ...
                        fields: vec![
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["COMBINE_UNSPECIFIED".into(), "AND".into(), "OR".into(), "AND_WITH_MATCHING_RESOURCE".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["SEVERITY_UNSPECIFIED".into(), "CRITICAL".into(), "ERROR".into(), "WARNING".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
    ...
    pub(super) fn monitoring_notificationchannel_schema() -> smelt_provider::ResourceTypeInfo {
        smelt_provider::ResourceTypeInfo {
                    ...
                    smelt_provider::SectionSchema {
                        ...
                        fields: vec![
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["VERIFICATION_STATUS_UNSPECIFIED".into(), "UNVERIFIED".into(), "VERIFIED".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
    ...
    pub(super) fn monitoring_uptimecheckconfig_schema() -> smelt_provider::ResourceTypeInfo {
        smelt_provider::ResourceTypeInfo {
                    ...
                    smelt_provider::SectionSchema {
                        ...
                        fields: vec![
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["CHECKER_TYPE_UNSPECIFIED".into(), "STATIC_IP_CHECKERS".into(), "VPC_CHECKERS".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Array(Box::new(smelt_provider::FieldType::Enum(vec!["REGION_UNSPECIFIED".into(), "USA".into(), "EUROPE".into(), "SOUTH_AMERICA".into(), "ASIA_PACIFIC".into(), "USA_OREGON".into(), "USA_IOWA".into(), "USA_VIRGINIA".into()]))),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
    ...
    pub(super) fn monitoring_group_schema() -> smelt_provider::ResourceTypeInfo {
        smelt_provider::ResourceTypeInfo {
