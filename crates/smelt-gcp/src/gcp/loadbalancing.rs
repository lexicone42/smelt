...
impl GcpProvider {
    pub(super) fn loadbalancing_backendservice_schema() -> smelt_provider::ResourceTypeInfo {
                    ...
                    smelt_provider::SectionSchema {
                        ...
                        fields: vec![
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["AUTOMATIC".into(), "DISABLED".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Float,
                                required: false,
                                default: None,
                                sensitive: false,
                            },
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["INVALID_LB_POLICY".into(), "LEAST_REQUEST".into(), "MAGLEV".into(), "ORIGINAL_DESTINATION".into(), "RANDOM".into(), "RING_HASH".into(), "ROUND_ROBIN".into(), "WEIGHTED_GCP_RENDEZVOUS".into(), "WEIGHTED_MAGLEV".into(), "WEIGHTED_ROUND_ROBIN".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["GRPC".into(), "H2C".into(), "HTTP".into(), "HTTP2".into(), "HTTPS".into(), "SSL".into(), "TCP".into(), "UDP".into(), "UNSPECIFIED".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["CLIENT_IP".into(), "CLIENT_IP_NO_DESTINATION".into(), "CLIENT_IP_PORT_PROTO".into(), "CLIENT_IP_PROTO".into(), "GENERATED_COOKIE".into(), "HEADER_FIELD".into(), "HTTP_COOKIE".into(), "NONE".into(), "STRONG_COOKIE_AFFINITY".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
    ...
    pub(super) fn loadbalancing_healthcheck_schema() -> smelt_provider::ResourceTypeInfo {
        smelt_provider::ResourceTypeInfo {
    ...
    pub(super) async fn create_loadbalancing_healthcheck(
        ...
        let timeout_sec = config.optional_i64("/config/timeout_sec");
        let _type_val = config.optional_str("/config/type").map(String::from);
        let unhealthy_threshold = config.optional_i64("/config/unhealthy_threshold");

        // Determine type from which check config is provided (before values are moved).
        // The SDK default is "INVALID" which GCP rejects.
        let hc_type = if tcp_health_check.is_some() {
            "TCP"
        } else if http_health_check.is_some() {
            "HTTP"
        } else if https_health_check.is_some() {
            "HTTPS"
        } else if grpc_health_check.is_some() {
            "GRPC"
        } else if ssl_health_check.is_some() {
            "SSL"
        } else if http_2_health_check.is_some() {
            "HTTP2"
        } else {
            "TCP" // default
        };
    ...
    pub(super) async fn update_loadbalancing_healthcheck(
        ...
        // Determine type before values are moved into the model
        let hc_type = if tcp_health_check.is_some() {
            "TCP"
        } else if http_health_check.is_some() {
            "HTTP"
    ...
    pub(super) fn loadbalancing_forwardingrule_schema() -> smelt_provider::ResourceTypeInfo {
        smelt_provider::ResourceTypeInfo {
                    ...
                    smelt_provider::SectionSchema {
                        ...
                        fields: vec![
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["PREPARE".into(), "TEST_ALL_TRAFFIC".into(), "TEST_BY_PERCENTAGE".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
                            ...
                            smelt_provider::FieldSchema {
                                ...
                                field_type: smelt_provider::FieldType::Enum(vec!["AH".into(), "ESP".into(), "ICMP".into(), "L3_DEFAULT".into(), "SCTP".into(), "TCP".into(), "UDP".into()]),
                                required: false,
                                default: None,
                                sensitive: false,
                            },
