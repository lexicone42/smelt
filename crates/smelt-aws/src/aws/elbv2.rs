...
impl AwsProvider {
    pub(super) fn elbv2_load_balancer_schema() -> smelt_provider::ResourceTypeInfo {
    ...
    pub(super) fn elbv2_target_group_schema() -> smelt_provider::ResourceTypeInfo {
        smelt_provider::ResourceTypeInfo {
    ...
    pub(super) fn elbv2_listener_schema() -> smelt_provider::ResourceTypeInfo {
        smelt_provider::ResourceTypeInfo {
