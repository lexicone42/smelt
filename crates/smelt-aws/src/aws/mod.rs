    ...
    fn read(
        ...
        Box::pin(async move {
            aws_dispatch_read!(self, resource_type.as_str(), provider_id, {
                ...
                "wafv2.WebACL" => read_wafv2_web_acl,
                // Generated (codegen)
    ...
    fn create(
        ...
        Box::pin(async move {
            aws_dispatch_create!(self, resource_type.as_str(), config, {
                ...
                "wafv2.WebACL" => create_wafv2_web_acl,
                // Generated (codegen)
        ...
        Box::pin(async move {
            aws_dispatch_update!(self, resource_type.as_str(), provider_id, new_config,
                updatable: {
                    ...
                    "wafv2.WebACL" => update_wafv2_web_acl,
    ...
    fn delete(
        ...
        Box::pin(async move {
            aws_dispatch_delete!(self, resource_type.as_str(), provider_id, {
                ...
                "wafv2.WebACL" => delete_wafv2_web_acl,
                // Generated (codegen)
