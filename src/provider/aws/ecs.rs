// Hybrid: Cluster is generated by smelt-codegen, Service + TaskDefinition are hand-written.
...
impl AwsProvider {
    ...
    // ─── ECS TaskDefinition (hand-written) ───────────────────────────
